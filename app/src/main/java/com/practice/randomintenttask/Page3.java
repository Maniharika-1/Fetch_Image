...
import com.practice.randomintenttask.Page1.ImageDownloader;
...
public class Page3 extends AppCompatActivity {
    ...
    public void download(View view)
    {
        ...
        try {
            Bitmap image = task.execute("https://homepages.cae.wisc.edu/~ece533/images/boat.png").get();
            if(image == null)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Page3.this, "Please wait a while after clicking the button...", Toast.LENGTH_SHORT).show();
    }
}
